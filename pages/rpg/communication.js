  ...
  <div className="communication">
    ...
    <div>
      ...
      <p>
        ...
        character). Then we return the trimmed string as we probably don't care about the spaces and
        it can make it harder to match strings later (for example "yes " === "yes" will return
