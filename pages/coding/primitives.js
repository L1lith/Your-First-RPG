...
export default () => (
  <div className="primitives">
    ...
    <span className="intro-card">
      ...
      <span>
        You can read more{" "}
        <a href="https://www.aleksandrhovhannisyan.com/blog/binary-for-beginners/">
          here
        </a>{" "}
        if you'd like to learn about how binary values are converted into more
        complex data types like strings and numbers.
      </span>
    </span>
    <br />
    <p>
      In this section we will upgrade from working with just boolean logic to
      writing functional JavaScript! Primitives represent the basic data types
      in JavaScript. The basic primitives values are as following:
    </p>
    ...
    <p>
      I will now detail each type of data and their operators, then in the next
      page I will provide some more examples of how they can be used together.
    </p>
    <div className="type boolean">
      <h2>Booleans</h2>
      <p>
        JavaScript has integrated support for boolean values and boolean
        operations.
      </p>
    ...
    <div className="type numbers">
      <h2>Numbers</h2>
      <p>
        Numbers can be integers (whole numbers like 33) or floats (short for
        floating point decimals like 45.512). Some basic operations are adding,
        multiplication, division, and subtraction. Besides changing the numbers
        you can also compare them (using symbols like &gt;, &lt;, or ≥) in order
        to output boolean values.
      </p>
    ...
    <div className="type strings">
      <h2>Strings</h2>
      <p>
        Strings are collections of text (like someones name, an address, etc).
        They are written by surrounding the text in single or double quotes.
      </p>
    ...
    <Link href="/">
      <a className="next">Up next: Building Complete Programs</a>
    </Link>
  </div>
);
