...
export default () => (
      ...
      <tbody>
        <tr>
          ...
          <td>
            ...
            development, and more. I'd highly recommend him if you're looking for an engaging way to
  ...
  https://stackoverflow.com/">
          ...
          <td>
            StackOverflow is a little like the yahoo answers of the programming world (but please
            don't spam silly questions). If you have an issue chances are someones had the exact
            same one before. If you're stuck and can't figure something out search on there,{' '}
        ...
        <tr>
          ...
          <td>
            The MDN is the most extensive site for learning about web technologies. It is maintained
            by the Mozilla foundation, but it can be overly technical or lacking information in
            certain areas
          </td>
        </tr>
        <tr>
